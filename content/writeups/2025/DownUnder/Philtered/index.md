...
![picture of the website showing how we caused the our-values.txt file to be read and loaded onto the page due to the command](1.png)
...
![picture of the website showing how instead of reading out flag.php, we got the text `You've just been philtered!`](2.png)
...
![picture of the website showing their being nothing in the area where we control the content](3.png)
