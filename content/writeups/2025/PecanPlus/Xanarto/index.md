...
![There are four repos `ColoursClass` `HELPDebtCalculator` `UnitConverters` `HomemadeEncryptionAlgorithm`](/writeups/2025/PecanPlus/Xanarto/2.png)
...
![6 commits `Update README.md` `Fixed importing issues` `removed confidential info` `Small edits` `The Actual algorithm` `Initial commit`](/writeups/2025/PecanPlus/Xanarto/3.png)
