...
![I have created an unbreakable code using my own encryption algorithm that you will never crack. '〈䕒峔嚶冪䒪䗺𪂪婂➸偔嗬㐂䏤寚☰𴲐' Go peasants, I will watch you flounder about as you attempt to solve even the simplest of problems. For I am Xanarto, programmer extrordanaire, and second to none.](1.png)
...
![There are four repos `ColoursClass` `HELPDebtCalculator` `UnitConverters` `HomemadeEncryptionAlgorithm`](2.png)
...
![6 commits `Update README.md` `Fixed importing issues` `removed confidential info` `Small edits` `The Actual algorithm` `Initial commit`](3.png)
