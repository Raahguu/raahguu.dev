...
![Spectrogram of a Wav file that shows dots and dashes, and also has embedded text at the end](/writeups/2025/L3akCTF/Strange-Transmission/1.png)
...
![Some morse code in a wav file shown through the spectrogram](/writeups/2025/L3akCTF/Strange-Transmission/2.png)

And here is a closeup of that text at the end of the spectrogram, slowed down to 10% speed, so that text is legible.

![Hidden text that was at the end of the spetrogram, that says `c4teg0ry_w3_h0p3_you_h4ve_fun!}`](/writeups/2025/L3akCTF/Strange-Transmission/3.png)
...
![Chart that displays a mapping/how to translate from morse code to english letters or vice versa](/writeups/2025/L3akCTF/Strange-Transmission/4.png)
