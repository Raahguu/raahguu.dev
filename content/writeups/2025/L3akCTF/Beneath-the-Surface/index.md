...
![Image of fldigi GUI, where the menu `Op Mode` has been selected, then `WEFAX`, showing the `WEFAX-IOC576` option](1.png)

3. Click `file`, `Audio`, and then `playback`
![Image of fldigi GUI where the menu `file` and then the submenu `Audio` have been selected in order to show the `playback` option](2.png)
...
6. There's your flag
![Image of the transmitted image that contains the flag in diagonal text accross it](3.png)
