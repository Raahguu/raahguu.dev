...
![PScreenshot of the pdf in Master of Time and Space which details the when and where an election booth will be for the freedonia election](writeups/2025/australian-cyber-security-games/Week-4/Master-of-Time-and-Space/1.png)
